...
command! -nargs=0 BufferOpenFirstHotswap lua require("buffer-me").open_first_hotswap()
command! -nargs=0 BufferOpenSecondHotswap lua require("buffer-me").open_second_hotswap()
